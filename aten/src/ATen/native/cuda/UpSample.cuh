...
// see NOTE [ Nearest neighbor upsampling kernel implementation ]
__device__ __forceinline__ inline int nearest_neighbor_compute_source_index(
    const float scale,
    int dst_index,
    int input_size) {
...
__device__ __forceinline__ inline int nearest_neighbor_exact_compute_source_index(
    const float scale,
    int dst_index,
    int input_size) {
...
// see NOTE [ Nearest neighbor upsampling kernel implementation ]
__device__ __forceinline__ inline int nearest_neighbor_bw_compute_source_index(
    const float scale,
    int dst_index,
    int output_size) {
...
// see NOTE [ Nearest neighbor upsampling kernel implementation ]
__device__ __forceinline__ inline int nearest_neighbor_exact_bw_compute_source_index(
    const float scale,
    int dst_index,
    int output_size) {
